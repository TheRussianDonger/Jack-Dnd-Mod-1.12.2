package jack.mod.world.gen.generators;
...
public class WorldGenCaesarTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.LOG_VICI.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_VICI.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenCaesarTree() 
	{
		super(false);
		this.minHeight = 12;
	}
	...
	protected boolean canGrowInto(Block blockType)
	{
        ...
        return material == Material.AIR || material == Material.LEAVES || material == Material.GROUND || blockType == Blocks.GRASS || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
