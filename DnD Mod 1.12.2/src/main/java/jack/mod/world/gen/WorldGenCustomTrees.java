package jack.mod.world.gen;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.Random;

import jack.mod.world.gen.generators.WorldGenCaesarTree;
...
{
	private final WorldGenerator CAESAR = new WorldGenCaesarTree();
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case 0:
			...
			runGenerator(CAESAR, world, random, chunkX, chunkZ, 5, Blocks.GRASS);/*, BiomeCopper.class*/
