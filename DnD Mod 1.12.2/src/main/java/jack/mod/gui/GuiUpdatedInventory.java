...
public class GuiUpdatedInventory extends InventoryEffectRenderer implements IRecipeShownListener
{
    ...
    private GuiButtonImage recipeButton, dndLaunchButton;
    ...
    public void initGui()
    {
        ...
        this.dndLaunchButton = new GuiButtonImage(11, this.guiLeft + 149, this.height / 2 - 22, 20, 18, 178, 0, 19, INVENTORY_BACKGROUND);
        this.buttonList.add(this.dndLaunchButton);
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.id == 10)
        {
            ...
            this.dndLaunchButton.setPosition(this.guiLeft + 149, this.height / 2 -22);
            this.buttonClicked = true;
        }
        if(button.id == 11)
        {
        	GuiIngameMenu menu = new GuiIngameMenu();
        	FMLClientHandler.instance().showGuiScreen(dndLaunchButton);
        }
    }
